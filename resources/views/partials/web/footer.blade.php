<footer class="footer bg-theme-light/50">
    <div class="container">
        <div class="row gx-5 pb-10 pt-[52px]">
            <div class="col-12 mt-12 md:col-6 lg:col-3">
                <a href="index.html">
                    <img src="{{ asset('assets/img/logos/512.png') }}" alt="Logo" style="height:40px;width:80px;"/>
                </a>
                <p class="mt-6">
    ...
    <div class="container max-w-[1440px]">
        <div class="footer-copyright mx-auto border-t border-border pb-10 pt-7 text-center">
            <p>Designed And Developed by <a href="javascript:void(0)" target="_blank">Md.Samiul Haque</a></p>
        </div>
    </div>
</footer>